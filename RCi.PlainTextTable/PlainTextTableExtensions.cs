namespace RCi.Toolbox.Ptt
{
    public static class PlainTextTableExtensions
    {
        ...
        public static Cell SetText(this Cell cell, object text) => cell.SetText(text.ToString() ?? string.Empty);
        ...
        public static Cell SetBorders(this Cell cell, Border uniform) => cell.SetBorders(new Borders(uniform));
        ...
        public static Cell SetLeftHorizontalAlignment(this Cell cell) =>
            cell.SetHorizontalAlignment(HorizontalAlignment.Left);

        public static Cell SetCenterHorizontalAlignment(this Cell cell) =>
            cell.SetHorizontalAlignment(HorizontalAlignment.Center);

        public static Cell SetRightHorizontalAlignment(this Cell cell) =>
        ...
        public static Cell SetCenterVerticalAlignment(this Cell cell) =>
            cell.SetVerticalAlignment(VerticalAlignment.Center);

        public static Cell SetBottomVerticalAlignment(this Cell cell) =>
