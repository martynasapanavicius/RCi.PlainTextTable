...
namespace RCi.Toolbox.Ptt
{
    ...
    public abstract class RowBase(PlainTextTable host, int row) : ControlBase(host)
    {
    ...
    public abstract class ColumnBase(PlainTextTable host, int col) : ControlBase(host)
    {
    ...
    public sealed class Row(PlainTextTable host, int row) : RowBase(host, row)
    {
    ...
    public sealed class Column(PlainTextTable host, int col) : ColumnBase(host, col)
    {
    ...
    public sealed class RowSpan(PlainTextTable host, int row, int offset, int length) : RowBase(host, row)
    {
    ...
    public sealed class ColumnSpan(PlainTextTable host, int col, int offset, int length) : ColumnBase(host, col)
    {
        public int Offset { get; } = offset;
        public int Length { get; } = length;
    ...
    public static class PlainTextTableMovementExtensions
    {
        ...
        public static Column AppendColumn(this PlainTextTable host, params string[] texts) =>
            host.AppendColumn().SetText(texts);

        public static Column AppendColumn(this PlainTextTable host, params object[] texts) =>
            host.AppendColumn().SetText(texts);

        public static Row Row(this PlainTextTable host, int row) => new(host, row);

        public static Row Row(this PlainTextTable host, Index row) =>
            new(host, row.IsFromEnd ? host.RowCount - row.Value : row.Value);

        public static Column Column(this PlainTextTable host, int col) => new(host, col);

        public static Column Column(this PlainTextTable host, Index col) =>
            new(host, col.IsFromEnd ? host.ColumnCount - col.Value : col.Value);
    ...
    public static class ControlMovementExtensions
    {
        ...
        public static RowSpan Slice(this RowBase rowBase, Index start, Index end) =>
            rowBase.Slice(new Range(start, end));

        public static RowSpan Slice(this RowBase rowBase, int offset, int length) =>
            rowBase.Slice(new Index(offset), new Index(offset + length));
        ...
        public static ColumnSpan Slice(this ColumnBase columnBase, Index start, Index end) =>
            columnBase.Slice(new Range(start, end));

        public static ColumnSpan Slice(this ColumnBase columnBase, int offset, int length) =>
            columnBase.Slice(new Index(offset), new Index(offset + length));
        ...
        public static RowSpan Slice(this Row row, int offset, int length) =>
            row.Slice(new Index(offset), new Index(offset + length));
        ...
        public static ColumnSpan Slice(this Column column, Index start, Index end) =>
            column.Slice(new Range(start, end));

        public static ColumnSpan Slice(this Column column, int offset, int length) =>
            column.Slice(new Index(offset), new Index(offset + length));
        ...
        public static RowSpan Slice(this RowSpan rowSpan, Index start, Index end) =>
            rowSpan.Slice(new Range(start, end));

        public static RowSpan Slice(this RowSpan rowSpan, int offset, int length) =>
            rowSpan.Slice(new Index(offset), new Index(offset + length));
        ...
        public static ColumnSpan Slice(this ColumnSpan columnSpan, Index start, Index end) =>
            columnSpan.Slice(new Range(start, end));

        public static ColumnSpan Slice(this ColumnSpan columnSpan, int offset, int length) =>
            columnSpan.Slice(new Index(offset), new Index(offset + length));
        ...
        public static Column MoveLeft(this Column column, int count = 1) =>
            new(column.Host(), column.ColumnIndex - count);

        public static Column MoveRight(this Column column, int count = 1) =>
            new(column.Host(), column.ColumnIndex + count);
        ...
        public static RowSpan MoveUp(this RowSpan rowSpan, int count = 1) =>
            new(rowSpan.Host(), rowSpan.RowIndex - count, rowSpan.Offset, rowSpan.Length);

        public static RowSpan MoveDown(this RowSpan rowSpan, int count = 1) =>
            new(rowSpan.Host(), rowSpan.RowIndex + count, rowSpan.Offset, rowSpan.Length);

        public static ColumnSpan MoveLeft(this ColumnSpan columnSpan, int count = 1) =>
            new(columnSpan.Host(), columnSpan.ColumnIndex - count, columnSpan.Offset, columnSpan.Length);

        public static ColumnSpan MoveRight(this ColumnSpan columnSpan, int count = 1) =>
            new(columnSpan.Host(), columnSpan.ColumnIndex + count, columnSpan.Offset, columnSpan.Length);

        public static RowSpan MoveUpToFirst(this RowSpan rowSpan) =>
            new(rowSpan.Host(), 0, rowSpan.Offset, rowSpan.Length);

        public static RowSpan MoveDownToLast(this RowSpan rowSpan) =>
            new(rowSpan.Host(), rowSpan.Host().RowCount - 1, rowSpan.Offset, rowSpan.Length);

        public static ColumnSpan MoveLeftToFirst(this ColumnSpan columnSpan) =>
            new(columnSpan.Host(), 0, columnSpan.Offset, columnSpan.Length);

        public static ColumnSpan MoveRightToLast(this ColumnSpan columnSpan) =>
            new(columnSpan.Host(), columnSpan.Host().ColumnCount - 1, columnSpan.Offset, columnSpan.Length);
    ...
    public static class ControlModifyExtensions
    {
            ...
            where TControl : ControlBase
        {
            ...
            {
                cell = cell is null ? firstCell : getNextCell(cell);
                setter(cell, value);
            }
            return control;
        }
        ...
        public static TControl SetText<TControl>(this TControl control, params string[] texts)
            where TControl : ControlBase => control.Apply((c, v) => c.SetText(v), control.First(), control.Next, texts);
        ...
        public static TControl SetText<TControl>(this TControl control, string text)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetText(v), text);
        ...
        public static TControl SetMargin<TControl>(this TControl control, Margin margin)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetMargin(v), margin);
        ...
        public static TControl SetRowSpan<TControl>(this TControl control, int rowSpan)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetRowSpan(v), rowSpan);
        ...
        public static TControl SetColumnSpan<TControl>(this TControl control, int columnSpan)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetColumnSpan(v), columnSpan);
        ...
        public static TControl SetBorders<TControl>(this TControl control, Borders borders)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetBorders(v), borders);
        ...
        public static TControl SetBorders<TControl>(this TControl control, Border border)
            where TControl : ControlBase => control.ApplyUniform((c, v) => c.SetBorders(v), border);

        public static TControl SetHorizontalAlignment<TControl>(
            this TControl control,
            params HorizontalAlignment[] horizontalAlignments
        )
            where TControl : ControlBase =>
        ...
        public static TControl SetLeftHorizontalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetHorizontalAlignment(HorizontalAlignment.Left);

        public static TControl SetCenterHorizontalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetHorizontalAlignment(HorizontalAlignment.Center);

        public static TControl SetRightHorizontalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetHorizontalAlignment(HorizontalAlignment.Right);

        public static TControl SetVerticalAlignment<TControl>(
            this TControl control,
            params VerticalAlignment[] verticalAlignments
        )
            where TControl : ControlBase =>
        ...
        public static TControl SetTopVerticalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetVerticalAlignment(VerticalAlignment.Top);

        public static TControl SetCenterVerticalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetVerticalAlignment(VerticalAlignment.Center);

        public static TControl SetBottomVerticalAlignment<TControl>(this TControl control)
            where TControl : ControlBase => control.SetVerticalAlignment(VerticalAlignment.Bottom);
    }
}
